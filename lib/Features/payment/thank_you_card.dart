...
import 'package:kamon/Features/payment/card_info_widget.dart';
import 'package:kamon/Features/payment/payment_info_item.dart';
import 'package:kamon/Features/payment/total_price_widget.dart';
    ...
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.only(
            top: 66, left: 22, right: 22), // Adjusted padding value
        child: Column(
          children: [
            const Text(
              'Thank you!',
